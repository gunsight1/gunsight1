ㆍ프론트,백엔드 경계의 모호한 날먹 개발자에서 근본을 갖춘 개발자로 변신을 꾀하는 사람
ㆍ귀차니즘을 잡고싶은 개발자
  - 귀차니즘을 잡기 위해선 여러번 같은 일을 하는 일을 예방해야한다.
  - 같은 일을 여러번 하지 않기 위해선 에러를 최소화 해야한다.
  - 에러를 최소화 하려면 꼼꼼한 설계와 클린코드가 뒷받침 되어야 한다.
  - 클린코드가 뒷받침 되려면 언어를 잘 이해해야 한다.
